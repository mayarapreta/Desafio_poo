...
public class Dev {
   ...
   private Set<Conteudo> conteudoInscritos = new LinkedHashSet<>();
    ...
    public  void inscreverBootcamp(Bootcamp bootcamp){
        //como tradudir isso na class mae
    ...
    public  void progredir(){
        ...
        if (conteudo.isPresent()){
            ...
            System.err.println("voce não esta maticulado em nenhum conteudo!");
        }
    }
 ...
 // estou trabalhando com LinkedHashSet . isso é hashcod (insert)
    @Override
